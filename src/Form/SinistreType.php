...
class SinistreType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('latitude', NumberType::class, array(
            ...
            'attr'=>array('class'=>'form-control','placeholder'=>'cliquez sur la carte', 'id'=>'sinistre_latitude')
        ))
        ...
        ->add('longitude', NumberType::class, array(
            ...
            'attr'=>array('class'=>'form-control','placeholder'=>'cliquez sur la carte', 'id'=>'sinistre_longitude')
        ))
        ;
    }
